...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/HungryBarFinal/register", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input id="username" name="username" type="text" required className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <input id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? "text" : "password"} required className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500" />
